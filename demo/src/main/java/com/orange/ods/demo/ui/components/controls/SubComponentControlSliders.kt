...
fun ControlSlidersContent() {
    ...
    Subtitle(R.string.component_controls_slider_discrete_lockups, withHorizontalPadding = false)
    OdsSliderLockups(
    ...
    Subtitle(R.string.component_controls_slider_continuous_lockups, withHorizontalPadding = false)
    OdsSliderLockups(
        modifier = Modifier.padding(top = dimensionResource(id = R.dimen.ods_spacing_s)),
