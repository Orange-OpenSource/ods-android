...
-- | -- | --
`appName: String` | | The name of the application displayed on the main screen of the About module
`privacyPolicyMenuItemFile: OdsAboutFileMenuItem.File` | | The privacy policy menu item file. Note that this menu item is mandatory and you MUST provide the corresponding file in the raw directory to display the privacy policy of your app.
`termsOfServiceMenuItemFile: OdsAboutFileMenuItem.File` | | The terms of service menu item file. Note that this menu item is mandatory and you MUST provide the corresponding file in the raw directory to display the terms of service for your app.
