 ...
 * @param trailing [OdsTextFieldTrailingBuilder] element to display at the end of the text field.
 ...
 * @param leadingIcon [OdsTextFieldLeadingIconBuilder] displayed at the beginning of the text field container.
 ...
 * @param characterCounter [OdsTextFieldCharacterCounterBuilder] displayed below the text field.
 */
@Composable
@OdsComposable
fun OdsTextField(
