...
private fun PreviewOdsIconToggleButton() = Preview {
    ...
    OdsIconToggleButton(
        ...
        uncheckedIcon = OdsIconButtonIconBuilder(painterResource(id = android.R.drawable.ic_media_play), "Play"),
        checkedIcon = OdsIconButtonIconBuilder(painterResource(id = android.R.drawable.ic_media_pause), "Pause"),
    )
}
