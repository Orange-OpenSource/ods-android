 ...
 * @param leadingIcon [OdsChipLeadingIconBuilder] displayed at the start of the chip, preceding the text.
 * @param leadingAvatar [OdsChipLeadingAvatarBuilder] displayed in a circle shape at the start of the chip, preceding the content text.
...
fun OdsChip(
    ...
    leadingIcon: OdsChipLeadingIconBuilder? = null,
...
private fun PreviewOdsChip() = Preview {
    ...
    OdsChip(
        ...
        leadingAvatar = OdsChipLeadingAvatarBuilder(painterResource(id = R.drawable.placeholder_small), "")
    )
}