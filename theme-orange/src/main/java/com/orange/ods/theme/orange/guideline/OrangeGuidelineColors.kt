...
val OrangeGuidelineColors = listOf(
    ...
    GuidelineColor(::ObsGrey700, R.color.core_obsgrey_700, GuidelineColorType.Core, "OBS Grey 700"),
    ...
    GuidelineColor(::Blue100, R.color.supporting_blue_100, GuidelineColorType.Supporting, "Blue 100"),
    GuidelineColor(::Blue200, R.color.supporting_blue_200, GuidelineColorType.Supporting, "Blue 200"),
    GuidelineColor(::Blue300, R.color.supporting_blue_300, GuidelineColorType.Supporting, "Blue 300"),
    GuidelineColor(::Green100, R.color.supporting_green_100, GuidelineColorType.Supporting, "Green 100"),
    GuidelineColor(::Green200, R.color.supporting_green_200, GuidelineColorType.Supporting, "Green 200"),
    GuidelineColor(::Green300, R.color.supporting_green_300, GuidelineColorType.Supporting, "Green 300"),
    GuidelineColor(::Pink100, R.color.supporting_pink_100, GuidelineColorType.Supporting, "Pink 100"),
    GuidelineColor(::Pink200, R.color.supporting_pink_200, GuidelineColorType.Supporting, "Pink 200"),
    GuidelineColor(::Pink300, R.color.supporting_pink_300, GuidelineColorType.Supporting, "Pink 300"),
    GuidelineColor(::Purple100, R.color.supporting_purple_100, GuidelineColorType.Supporting, "Purple 100"),
    GuidelineColor(::Purple200, R.color.supporting_purple_200, GuidelineColorType.Supporting, "Purple 200"),
    GuidelineColor(::Purple300, R.color.supporting_purple_300, GuidelineColorType.Supporting, "Purple 300"),
    GuidelineColor(::Yellow100, R.color.supporting_yellow_100, GuidelineColorType.Supporting, "Yellow 100"),
    GuidelineColor(::Yellow200, R.color.supporting_yellow_200, GuidelineColorType.Supporting, "Yellow 200"),
    GuidelineColor(::Yellow300, R.color.supporting_yellow_300, GuidelineColorType.Supporting, "Yellow 300")
)