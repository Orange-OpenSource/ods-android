    ...
    with(customizationState) {
        Column(
            ...
            CodeImplementationColumn {
                ComposableCode(name = OdsComponent.OdsHorizontalCard.name, parameters = mutableListOf(
                    SimpleParameter.ValueOnlyParameter("imagePosition", imagePosition.value.name),
                    ...
                    if (!hasDivider) add(SimpleParameter.StringRepresentationParameter("dividerEnabled", hasDivider))
                })
            }
        }
    }
